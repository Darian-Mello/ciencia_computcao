...
//Enqueue
bool enfileirarF(Fila *f, aviao valor) /// incluir valor na fila
{
...
//Dequeue
bool desenfileirarF(Fila *f, aviao *valor)  //retirar da fila
{
...
void mostraF(Fila *f)
{
    ...
    if (!vaziaF(f))
    {
        ...
        {
            cout << endl << i+1 << "º Avião:\n";
            cout << "\nCódigo: " << f->dados[idx].cod;
            cout << "\nEmpresa: " << f->dados[idx].empresa;
            cout << "\nCapacidade de passageiros: " << f->dados[idx].passageiros;
